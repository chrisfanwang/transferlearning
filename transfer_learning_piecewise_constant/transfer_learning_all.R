...
result_fl_T_all =  array(NA, dim = c(length(sig.delta_1_list), length(H_k_list), length(A_list),  length(gamma_list), simu))
...
result_l0_T_all =  array(NA, dim = c(length(sig.delta_1_list), length(H_k_list), length(A_list),  length(gamma_list), simu))
    ...
    for (A_index in 1:length(A_list)){
      ...
      for (gamma_index in 1:length(gamma_list)) {
        ...
        for (simu_test in 1:simu){
          ...
          result_fl_T_all_test = fusedlasso1d(y_all_project)
          
          cv_fl_T_all_test = cv.trendfilter(result_fl_T_all_test, k=5)
          
          fit_fl_T_all_test = coef(result_fl_T_all_test, lambda = cv_fl_T_all_test$lambda.min)$beta
          
          result_fl_T_all[sig.delta_1_index, H_k_index, A_index,gamma_index, simu_test] = sum((fit_fl_T_all_test -f_0)^2)/n_0
          ...
          fit_l0_T_all_test =  cv_l_0_est(y_all_project) 
          
          result_l0_T_all[sig.delta_1_index, H_k_index, A_index,gamma_index, simu_test] = sum((fit_l0_T_all_test-f_0)^2)/n_0
...
value_1 = c(mean(result_fl[1,1,1,1,]), mean(result_fl_T_1[1,1,1,1,]), mean(result_fl_T_ora[1,1,1,1,]), mean(result_fl_T_est[1,1,1,1,]), mean(result_fl_T_all[1,1,1,1,]), 
            mean(result_l0[1,1,1,1,]), mean(result_l0_T_1[1,1,1,1,]), mean(result_l0_T_ora[1,1,1,1,]), mean(result_l0_T_est[1,1,1,1,]), mean(result_l0_T_all[1,1,1,1,]),
            mean(result_fl[1,1,2,1,]), mean(result_fl_T_1[1,1,2,1,]), mean(result_fl_T_ora[1,1,2,1,]), mean(result_fl_T_est[1,1,2,1,]), mean(result_fl_T_all[1,1,2,1,]),
            mean(result_l0[1,1,2,1,]), mean(result_l0_T_1[1,1,2,1,]), mean(result_l0_T_ora[1,1,2,1,]), mean(result_l0_T_est[1,1,2,1,]), mean(result_l0_T_all[1,1,2,1,]),
            mean(result_fl[1,1,3,1,]), mean(result_fl_T_1[1,1,3,1,]), mean(result_fl_T_ora[1,1,3,1,]), mean(result_fl_T_est[1,1,3,1,]), mean(result_fl_T_all[1,1,3,1,]), 
            mean(result_l0[1,1,3,1,]), mean(result_l0_T_1[1,1,3,1,]), mean(result_l0_T_ora[1,1,3,1,]), mean(result_l0_T_est[1,1,3,1,]), mean(result_l0_T_all[1,1,3,1,]),
            mean(result_fl[1,1,4,1,]), mean(result_fl_T_1[1,1,4,1,]), mean(result_fl_T_ora[1,1,4,1,]), mean(result_fl_T_est[1,1,4,1,]), mean(result_fl_T_all[1,1,4,1,]),
            mean(result_l0[1,1,4,1,]), mean(result_l0_T_1[1,1,4,1,]), mean(result_l0_T_ora[1,1,4,1,]), mean(result_l0_T_est[1,1,4,1,]), mean(result_l0_T_all[1,1,4,1,]))


se_1 = c(std.error(result_fl[1,1,1,1,]), std.error(result_fl_T_1[1,1,1,1,]), std.error(result_fl_T_ora[1,1,1,1,]), std.error(result_fl_T_est[1,1,1,1,]), std.error(result_fl_T_all[1,1,1,1,]), 
         std.error(result_l0[1,1,1,1,]), std.error(result_l0_T_1[1,1,1,1,]), std.error(result_l0_T_ora[1,1,1,1,]), std.error(result_l0_T_est[1,1,1,1,]), std.error(result_l0_T_all[1,1,1,1,]),
         std.error(result_fl[1,1,2,1,]), std.error(result_fl_T_1[1,1,2,1,]), std.error(result_fl_T_ora[1,1,2,1,]), std.error(result_fl_T_est[1,1,2,1,]), std.error(result_fl_T_all[1,1,2,1,]), 
         std.error(result_l0[1,1,2,1,]), std.error(result_l0_T_1[1,1,2,1,]), std.error(result_l0_T_ora[1,1,2,1,]), std.error(result_l0_T_est[1,1,2,1,]), std.error(result_l0_T_all[1,1,2,1,]),
         std.error(result_fl[1,1,3,1,]), std.error(result_fl_T_1[1,1,3,1,]), std.error(result_fl_T_ora[1,1,3,1,]), std.error(result_fl_T_est[1,1,3,1,]), std.error(result_fl_T_all[1,1,3,1,]), 
         std.error(result_l0[1,1,3,1,]), std.error(result_l0_T_1[1,1,3,1,]), std.error(result_l0_T_ora[1,1,3,1,]), std.error(result_l0_T_est[1,1,3,1,]), std.error(result_l0_T_all[1,1,3,1,]),
         std.error(result_fl[1,1,4,1,]), std.error(result_fl_T_1[1,1,4,1,]), std.error(result_fl_T_ora[1,1,4,1,]), std.error(result_fl_T_est[1,1,4,1,]), std.error(result_fl_T_all[1,1,4,1,]),
         std.error(result_l0[1,1,4,1,]), std.error(result_l0_T_1[1,1,4,1,]), std.error(result_l0_T_ora[1,1,4,1,]), std.error(result_l0_T_est[1,1,4,1,]), std.error(result_l0_T_all[1,1,4,1,]))

Method = rep(c('FL', 'FL-T-1', 'FL-T-ora', 'FL-T-est', 'FL-T-all', 'L0','L0-T-1', 'L0-T-ora', 'L0-T-est', 'L0-T-all'), times = 4)
...
d_1$Method <- factor(d_1$Method, levels =c('FL', 'FL-T-1', 'FL-T-ora', 'FL-T-est', 'FL-T-all', 'L0','L0-T-1', 'L0-T-ora', 'L0-T-est', 'L0-T-all'))

color_list <- setNames(c("#66c2a5", "#fc8d26", "#8da0cb", "#e78ac3", "#a6d854", "#484B8A", "#e5c494", "#ffd92f", "#b3b3bc", "#C35817"),
                       levels(d_1$Method))
...
plott_1 = ggplot(data = d_1, mapping = aes(x = A, y = value, colour = Method)) +
  ...
  scale_color_manual(
    values = color_list,
    labels = c(TeX("$\u2113_1$"), TeX("$\u2113_1$-T-1"),TeX("$\u2113_1$-T-$A$"), TeX("$\u2113_1$-T-$\\widehat{A}$"), TeX("$\u2113_1$-T-$[K]$"),  
               TeX("$\u2113_0$"), TeX("$\u2113_0$-T-1"),TeX("$\u2113_0$-T-$A$"), TeX("$\u2113_0$-T-$\\widehat{A}$"), TeX("$\u2113_0$-T-$[K]$"))
  ) +
  theme_classic()
...
#Plot 2: configuration 2 and vary A  
...
value_2 = c(mean(result_fl[1,1,1,1,]), mean(result_fl_T_1[1,1,1,1,]), mean(result_fl_T_ora[1,1,1,1,]), mean(result_fl_T_est[1,1,1,1,]), mean(result_fl_T_all[1,1,1,1,]), 
            mean(result_l0[1,1,1,1,]), mean(result_l0_T_1[1,1,1,1,]), mean(result_l0_T_ora[1,1,1,1,]), mean(result_l0_T_est[1,1,1,1,]), mean(result_l0_T_all[1,1,1,1,]),
            mean(result_fl[1,1,2,1,]), mean(result_fl_T_1[1,1,2,1,]), mean(result_fl_T_ora[1,1,2,1,]), mean(result_fl_T_est[1,1,2,1,]), mean(result_fl_T_all[1,1,2,1,]),
            mean(result_l0[1,1,2,1,]), mean(result_l0_T_1[1,1,2,1,]), mean(result_l0_T_ora[1,1,2,1,]), mean(result_l0_T_est[1,1,2,1,]), mean(result_l0_T_all[1,1,2,1,]),
            mean(result_fl[1,1,3,1,]), mean(result_fl_T_1[1,1,3,1,]), mean(result_fl_T_ora[1,1,3,1,]), mean(result_fl_T_est[1,1,3,1,]), mean(result_fl_T_all[1,1,3,1,]), 
...
se_2 = c(std.error(result_fl[1,1,1,1,]), std.error(result_fl_T_1[1,1,1,1,]), std.error(result_fl_T_ora[1,1,1,1,]), std.error(result_fl_T_est[1,1,1,1,]), std.error(result_fl_T_all[1,1,1,1,]), 
         std.error(result_l0[1,1,1,1,]), std.error(result_l0_T_1[1,1,1,1,]), std.error(result_l0_T_ora[1,1,1,1,]), std.error(result_l0_T_est[1,1,1,1,]), std.error(result_l0_T_all[1,1,1,1,]),
         std.error(result_fl[1,1,2,1,]), std.error(result_fl_T_1[1,1,2,1,]), std.error(result_fl_T_ora[1,1,2,1,]), std.error(result_fl_T_est[1,1,2,1,]), std.error(result_fl_T_all[1,1,2,1,]), 
         std.error(result_l0[1,1,2,1,]), std.error(result_l0_T_1[1,1,2,1,]), std.error(result_l0_T_ora[1,1,2,1,]), std.error(result_l0_T_est[1,1,2,1,]), std.error(result_l0_T_all[1,1,2,1,]),
         std.error(result_fl[1,1,3,1,]), std.error(result_fl_T_1[1,1,3,1,]), std.error(result_fl_T_ora[1,1,3,1,]), std.error(result_fl_T_est[1,1,3,1,]), std.error(result_fl_T_all[1,1,3,1,]), 
...
d_2 = data.frame(A = A, Method = Method, value = value_2, se = se_2)

d_2$Method <- factor(d_2$Method, levels =c('FL', 'FL-T-1', 'FL-T-ora', 'FL-T-est', 'FL-T-all', 'L0','L0-T-1', 'L0-T-ora', 'L0-T-est', 'L0-T-all'))

color_list <- setNames(c("#66c2a5", "#fc8d26", "#8da0cb", "#e78ac3", "#a6d854", "#484B8A", "#e5c494", "#ffd92f", "#b3b3bc", "#C35817"),
                       levels(d_2$Method))


plott_2 = ggplot(data = d_2, mapping = aes(x = A, y = value, colour = Method)) +
  geom_line() + 
  geom_point()+ 
